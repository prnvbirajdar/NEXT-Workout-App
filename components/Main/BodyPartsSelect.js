            ...
            {exerciseList1.map((e) => (
              <div key={e.id} onClick={openExerciseModal}>
                <button
                  ...
                  className="text-sm md:text-base shadow-lg m-1.5 h-10 px-5 sm:m-2 sm:h-10 sm:px-5 text-indigo-100 transition-colors duration-150 bg-indigo-700 rounded-full focus:shadow-outline hover:bg-indigo-800"
                >
                  {e.muscle}
                </button>
              </div>
